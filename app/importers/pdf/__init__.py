...
BANKS = ["traderepublic", "degiro", "dekabank", "wirbank", "ebase", "swissquote", "quirin", "saxobank", "hbl", "findependent", "olb", "ffb", "tradegate", "bondora", "boursobank", "renaultbank", "akfbank", "lgt", "llb", "neon", "tigerbrokers", "questrade", "unicredit", "sunrise", "bankslm", "dreibanken", "n26", "c24", "estateguru", "boursedirect", "bbva", "vanguard", "sydbank", "selfwealth", "schelhammer", "pictet", "creditsuisse", "barclays", "bison", "apobank", "solaris", "revolut", "fidelity", "bsdex", "directa", "ajbell", "vdk", "stake", "scorepriority", "nordax", "openbank", "hargreaves", "aviva", "trading212", "whitebox", "modena", "firstrade", "kfintech", "commsec", "bundesschatz", "bigbank", "anadibank", "audibank", "advanzia", "abnamro", "suresse", "wealthsimple", "medirect", "debitum", "bank11", "ayvens", "alpaca", "ginmon", "fordmoney", "crowdestor", "etrade", "computershare", "creditmutuel", "cetesdirecto", "dbs", "ocbc", "uob", "maybank", "standardchartered", "trust", "hsbc", "citibank", "amex", "bankofamerica", "firstdirect", "kantonalbank", "comdirect", "ingdiba", "consorsbank", "baaderbank", "scalablecapital", "flatex", "dwpbank", "dab", "deutschebank", "targobank", "commerzbank", "bawag", "erstebank", "postfinance", "zkb", "ubs", "keytrade", "kbc", "arkea"]
