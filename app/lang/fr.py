...
STRINGS: dict[str, str] = {
    ...
    'Saved. Now log in from the account page — Trade Republic will ask its app to approve.': "Enregistré. Connectez-vous maintenant depuis la page du compte — Trade Republic demandera l'approbation dans son app.",
    ...
    'Then log in from the account page: the app asks to approve, or for a code.': "Puis connectez-vous depuis la page du compte : l'app demande une approbation ou un code.",
