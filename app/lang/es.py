...
STRINGS: dict[str, str] = {
    ...
    'Saved. Now log in from the account page — Trade Republic will ask its app to approve.': 'Guardado. Ahora inicia sesión desde la página de la cuenta — Trade Republic pedirá aprobación en su app.',
    ...
    'Then log in from the account page: the app asks to approve, or for a code.': 'Luego inicia sesión desde la página de la cuenta: la app pide aprobación o un código.',
