...
STRINGS: dict[str, str] = {
    ...
    'Saved. Now log in from the account page — Trade Republic will ask its app to approve.': 'Gespeichert. Melde dich jetzt von der Kontoseite aus an — Trade Republic lässt seine App bestätigen.',
    ...
    'Then log in from the account page: the app asks to approve, or for a code.': 'Dann melde dich von der Kontoseite aus an: die App fragt nach Bestätigung oder nach einem Code.',
